---
name: mcp-setup
description: Use when the user wants to configure or set up a Glean MCP server connection in Cursor. Triggers on "set up Glean", "configure Glean MCP", "connect Glean to Cursor", "add Glean MCP server", or similar setup requests.
---
